    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="card" style="padding:10px;margin-bottom: 10px;">
                ...
                <div style="display: flex; justify-content: center; align-items: center; gap:20px;  width: 100%;" hidden>
...
<script type="text/javascript">
    ...
    document.getElementById('btnNext').addEventListener('click',()=>{
        ...
        if(document.getElementById('answer').checked == true || document.getElementById('wrong').checked == true){
            //alert('Selected')
            ...
            for(i=0; records.length > i;i++){
                if(records[i].wrong == selectedChoose && records[i].id == wrongID){
                    console.log('Wrong')
                    selectAnswer.push({id:records[ctr].id, question: records[ctr].question, answer: selectedChoose});
                    wrongCounter++;
