        ...
        <div class="col-md-6">
            ...
            <div>
                ...
                @csrf
                    ...
                    <div class="form-group" style="margin-bottom: 20px;">
                        <label for="wrong">Wrong</label>
                        <input type="text" name="wrong1" value="{{ old('wrong1') }}" class="form-control" id="wrong1" aria-describedby="emailHelp" placeholder="Enter Wrong1">
                        @if($errors->has('wrong1'))
                            <small class="text-danger">* Required</small>
                        @endif
                    </div>
                    <div class="form-group" style="margin-bottom: 20px;">
                        <label for="wrong">Wrong</label>
                        <input type="text" name="wrong2" value="{{ old('wrong2') }}" class="form-control" id="wrong2" aria-describedby="emailHelp" placeholder="Enter Wrong2">
                        @if($errors->has('wrong2'))
                            <small class="text-danger">* Required</small>
                        @endif
                    </div>
                    <!-- <div class="form-group" style="margin-bottom: 20px;">
